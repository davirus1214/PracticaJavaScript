...
const crearPersona = (nombre, apellido) => ({nombre, apellido }); // Los parentesis le indican a JV que va a retornar un objeto {}. Si no coloco esos parentesis entonces me retorna undefined
